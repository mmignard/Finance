...
tr = np.genfromtxt('.//data//MaxTaxRate.csv',delimiter=',',skip_header=1,unpack=True,dtype=float)
trEff = np.genfromtxt('.//data//HistoricalTaxRate.csv',delimiter=',',skip_header=1,unpack=True,dtype=float)
plt.figure(figsize=(5,3.5),dpi=300)
